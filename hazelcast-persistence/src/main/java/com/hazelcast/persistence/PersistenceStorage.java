...
public class PersistenceStorage {
	...
	public boolean destroy(String referenceId, ConstructType constructType, String name) {
		...
		try {
			try {
				storeImplementationMap.lock(configKey);
			...
			storeImplementationMap.unlock(configKey);
			storeImplementationMap.removeLock(configKey);
		}
		return removed.get();
	}
	...
	private boolean initStore(ConstructType constructType,
							  String referenceId,
							  String name,
